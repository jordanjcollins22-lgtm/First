...
const STOPS: Stop[] = [
  { jobId: "j1", sessionId: "s-j1", address: "12 Elm St", customerName: "Pat", lat: 39.5, lng: -76.3, purpose: "Bed rebuild" },
  { jobId: "j2", sessionId: "s-j2", address: "40 Oak Ave", customerName: "Sam", lat: 39.6, lng: -76.4, purpose: "Mulch" },
];

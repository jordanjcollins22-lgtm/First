...
const clientJourney: JourneyTemplate = {
  ...
  steps: [
    ...
    },
    {
      ...
      nextSteps: ["proposal_approval"],
      estMinutes: 0,
      notes: "Silently does nothing if the evaluation has no zones/services on it yet.",
    },
    {
      stepKey: "proposal_approval",
      order: 5,
      label: "Account Manager Reviews Proposal",
      ...
      clicks: 1,
      estMinutes: 1,
      notes: "The Proposals tab groups every proposal into Needs Approval / Sent / Declined / Accepted for exactly this queue.",
    },
    {

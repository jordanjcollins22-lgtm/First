...
export const TABS: readonly TabDefinition[] = [
  ...
  { key: "group-agent", label: "Where Posts Come From", href: "/admin/outreach/agent", parent: "recommendations" },
...
export const UNGOVERNED_ROUTES: Record<string, string> = {
  ...
  "/operations":
    "One of the four departments. Same reason as /sales: the calendar, the evaluations, the job board, " +
    "the crew, the weather and the salt route, each at its own permission.",
  "/marketing": "One of the four departments. Same reason as /sales: the map, the leads, the print tools and the posts, each at its own permission.",
  "/admin":
    "The department holding everything the business runs on. It lists only pages the viewer already " +
    "has permission for and links to nothing else, so a tick of its own would withhold nothing and " +
    "could leave somebody with no way to reach a page they were granted.",
};

...
`,
  ...
  {
    file: "0126_proposal_views.sql",
    creates: ["proposal_views"],
    adds: [],
    sql: `-- Whether the client has actually opened their proposal.
--
...
`,
  ...
  {
    file: "0127_flyer_bookings.sql",
    creates: ["flyer_runs","flyer_bookings"],
    adds: [],
    sql: `-- Selling a flyer spot to somebody outside the business.
--
...
`,
  ...
  {
    file: "0128_business_contact_type.sql",
    creates: [],
    adds: [],
    sql: `-- Local businesses we approach about the flyer.
--
...
`,
  ...
  {
    file: "0129_flyer_artwork_kind.sql",
    creates: [],
    adds: ["flyer_bookings.artwork_kind"],
    sql: `-- Whether the advertiser sent a finished advert or a reference.
--
...
`,
  ...
  {
    file: "0130_flyer_upload_limit.sql",
    creates: [],
    adds: [],
    sql: `-- A size ceiling on advertiser artwork.
--
...
`,
  ...
  {
    file: "0131_proposal_edits.sql",
    creates: ["proposal_edits"],
    adds: [],
    sql: `-- What the office took off a proposal after it went out.
--
...
`,
  ...
  {
    file: "0132_conversation_reads.sql",
    creates: ["conversation_reads"],
    adds: ["job_messages.reference_label"],
    sql: `-- Two things the inbox could not say.
--
...
`,
  ...
  {
    file: "0133_proposal_edit_source.sql",
    creates: [],
    adds: ["proposal_edits.requested_via"],
    sql: `-- Where a change to a proposal came from.
--
...
`,
  ...
  {
    file: "0134_evaluation_edits.sql",
    creates: ["evaluation_edits"],
    adds: [],
    sql: `-- Changes made to an evaluation after the walk.
--
...
`,
  ...
  {
    file: "0135_pipeline_override.sql",
    creates: [],
    adds: ["jobs.pipeline_override_stage"],
    sql: `-- Moving a job on the board by hand.
--
...
`,
  ...
  {
    file: "0136_contact_import_conflict_target.sql",
    creates: [],
    adds: [],
    sql: `-- The index the contact import upserts onto.
--
...
`,
  ...
  {
    file: "0137_job_disputes.sql",
    creates: [],
    adds: ["jobs.dispute_opened_at"],
    sql: `-- Jobs that have gone wrong.
--
...
`,
  ...
  {
    file: "0138_archived_proposals.sql",
    creates: ["archived_proposals"],
    adds: [],
    sql: `-- The proposals that were written before this app existed.
--
...
`,
  ...
  {
    file: "0139_payment_import.sql",
    creates: [],
    adds: ["payments.external_id"],
    sql: `-- Payments brought in from wherever the money was actually taken.
--
...
`,
  ...
  {
    file: "0140_processing_fees.sql",
    creates: [],
    adds: ["ledger_entries.external_id"],
    sql: `-- Card fees, and a stable key for anything imported into the ledger.
--
...
`,
  ...
  {
    file: "0141_payment_payer.sql",
    creates: [],
    adds: ["payments.payer_name"],
    sql: `-- Who the payment said it was from.
--
...
`,
  ...
  {
    file: "0142_client_invoices.sql",
    creates: ["client_invoices"],
    adds: [],
    sql: `-- Invoices, as files, against the person they were sent to.
--
...
`,
  ...
  {
    file: "0143_invoice_payment_plans.sql",
    creates: [],
    adds: ["payment_plans.invoice_id"],
    sql: `-- A payment plan against the invoice it settles.
--
...
`,
  ...
  {
    file: "0144_invoice_import.sql",
    creates: [],
    adds: ["client_invoices.title"],
    sql: `-- Invoices brought in from wherever they were raised.
--
...
`,
  ...
  {
    file: "0145_payment_surcharge.sql",
    creates: [],
    adds: ["payments.surcharge_cents"],
    sql: `-- The part of a payment that was the card fee rather than the work.
--
...
`,
  ...
  {
    file: "0146_payment_invoice_link.sql",
    creates: [],
    adds: ["payments.invoice_id"],
    sql: `-- Which bill a payment settled.
--

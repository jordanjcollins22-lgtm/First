...
export const MODULES: readonly AppModule[] = [
  ...
  },
  {
    ...
    subtabs: [
      ...
      { key: "content", label: "Content", tabs: ["social", "campaigns", "recommendations", "posts-to-answer", "group-agent", "booking-page"], blurb: "Before and after posts from the crew's own photos, and a tracked link on every post, comment and message that goes out." },

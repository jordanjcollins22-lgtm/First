...
import { agentCounts, getAgentSettings, recentAgentActivity } from "@/lib/data/outreach-agent";
    ...
    <div className="mx-auto w-full max-w-3xl space-y-5 px-4 py-6">
      <header>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          The browser button&apos;s big brother. With the extension installed and Chrome open, it looks through
          the groups below every so often, reads any post that mentions the work, writes the comment with a
          tracked link, and posts it under the caps set here. Everything it does lands on the Link Tracking
          board like a comment written by hand.
        </p>
      </header>

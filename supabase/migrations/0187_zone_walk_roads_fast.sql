-- The walk on OpenStreetMap roads, within the database's means.
--
-- The first walk on the roads took the sidewalks too (a piece every ten
-- metres beside every street, four times the streets) and matched every

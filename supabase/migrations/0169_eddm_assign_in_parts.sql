...
-- doing one part. The last part writes the counts. The reach is ninety
-- metres: a suburban lot's centroid sits twenty to forty metres from the
-- street, a bigger lot's further, and a hundred metres would start
-- attaching a new street's houses to the old street behind it.
